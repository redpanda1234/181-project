...
\begin{abstract}
  \textbf{Abstract} We describe two models of computation, DFAs and Turing machines, and how they can be represented as Turing machines. We also describe the computability hierarchy of languages and relate this to these models of computation. We discuss what it means for an arbitrary symbolic dynamical system to have computational universality (loosely defined as ``the computational power of an arbitrary Turing machine''), and motivate in detail one particular definition.
...
{\Huge Example citation: \cite{Kurka1997Mar}}
